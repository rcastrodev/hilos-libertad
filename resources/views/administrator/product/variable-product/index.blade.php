                    ...
                    <table class="table">
                        <td>
                            <div class="form-group d-flex align-items-center">
                                ...
                                <input type="text" name="code" value="{{$vp->code}}" placeholder="001 002" class="form-control">
                            </div>
                        </td>
                        <td>
                            <div class="form-group d-flex align-items-center">
                                <span class="mr-2" style="color: red;">*</span>
                                <input type="text" name="measure" value="{{$vp->measure}}" placeholder="1mm 2mm 3mm" class="form-control">
                            </div>
                        </td>
                        <td>
                            <div class="form-group d-flex align-items-center">
                                <span class="mr-2" style="color: red;">*</span>
                                <input type="text" name="packaging" value="{{$vp->packaging}}" placeholder="Carretel de 1000 mts" class="form-control">
                            </div>
                        </td>
                        <td>
            ...
            <div class="table-responsive">
                <table class="table">
                    <td>
                        <div class="form-group d-flex align-items-center">
                            <span class="mr-2" style="color: red;">*</span>
                            <input type="text" name="code" placeholder="001 002" class="form-control">
                        </div>
                    </td>
                    <td>
                        <div class="form-group d-flex align-items-center">
                            <span class="mr-2" style="color: red;">*</span>
                            <input type="text" name="measure" placeholder="1mm 2mm 3mm" class="form-control">
                        </div>
                    </td>
                    <td>
                        <div class="form-group d-flex align-items-center">
                            <span class="mr-2" style="color: red;">*</span>
                            <input type="text" name="packaging" placeholder="Carretel de 1000 mts" class="form-control">
                        </div>
                    </td>
                    <td>
